...
(define python-path "/usr/bin/python3")
...
(command-line
  ...
  ("--get-surface" "Get surface syntax for python"
   (pretty-write (get-structured-python (parse-python/port (current-input-port) python-path))))
